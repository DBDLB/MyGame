...
public class ChildClickToShowUI : ClickToShowUI
{
    ...
    void Start()
    {
        ...
        DeleteButton = ClickToShowUI.Instance.DeleteButton;
        CreateButton = ClickToShowUI.Instance.CreateButton;
        CancelCreateButton = ClickToShowUI.Instance.CancelCreateButton;
        ClickToShowUI.Instance.childClickToShowUIs.Add(this);
    }
    ...
    //     {
    //         if (variousAnt.antTrack != null && variousAnt.antTrack.enabled)
    //         {
    //             isDrawLine = variousAnt.antTrack.enabled;
    //         }
    //     }
    //
    //
    //     if (Input.GetMouseButtonDown(0)&& !AntColony.Instance.flyingAntTrack.enabled && !isDrawLine )
    //     {
    //         Debug.Log(!AntColony.Instance.flyingAntTrack.enabled);
    //         Ray ray = Camera.main.ScreenPointToRay(Input.mousePosition);
    //         RaycastHit hit;
