...
public class LiquidBottleManager : MonoBehaviour
{
    ...
    private void Start()
    {
        mat_Liquid = rdr_Liquid.sharedMaterial;
...
#region RenderFeature
    ...
    public void SetRenderMode(bool bUseRenderFeatureIN)
    {
        ...
        rdr_Liquid.sharedMaterial.SetVector(RPass_LiquidBottle.id_RelativeOriginAndFlag, Vector4.zero);   // 使用shader中的包围盒变量计算水平液面
